class Score < ActiveRecord::Base
  ...
  def calculate_licensee_legal_risk
    ...
    self.licensee_legal_risk =
        choice_of_forum_score  * SCORE_WEIGHTS[:attributes][:choice_of_forum] +
        choice_of_law_score    * SCORE_WEIGHTS[:attributes][:choice_of_law] +
  ...
  def disclaimer_score
    licence.disclaimer.disclaimer_liability ? 0.0 : 1.0
  end
  ...
  def indemnity_score
    licence.disclaimer.disclaimer_indemnity ? 0.0 : 1.0
  end
  ...
  # licensee
  def unilateral_change_score
    licence.changes_to_term.licence_changes_effective_immediately ? 0 : 1.0
  end
  ...
  def termination_risk_score
    score = if licence.termination.termination_discretionary
      0
    ...
    score += (1.0 / 3.0) if licence.termination.termination_reinstatement
    score
  end
